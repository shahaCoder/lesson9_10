...
// Отфильтровать задачи в переменные а и b
    ...
    // Первый вариант решеения данной задачи через for of
    ...
    for (let item of users){
        ...
        else if (item.email.includes(".biz")){
            emails.biz.push(item.email)
        }
        else if (item.email.includes(".tv") || item.email.includes(".me") || item.email.includes(".io") || item.email.includes(".ca") ){
    ...
    console.log(emails.biz)
    console.log(other)

    // Второй вариант полностью эквивалентен первой,используется метод filter()

    // let newm = users.filter(item => {
    //     if(item.email.includes(".org")){
    //         emails.org.push(item.email)
    //     }
    //     else if(item.email.includes(".net")){
